...
class LocalStatsGrid extends StatefulWidget {
  @override
  _LocalStatsGridState createState() => _LocalStatsGridState();
}

class _LocalStatsGridState extends State<LocalStatsGrid> {
  @override
